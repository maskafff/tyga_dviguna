...
win = QWidget()
win.resize(700, 500)
win.setWindowTitle('Фото редактор')
...
def showFilenamesList():
    extentions = ['.jpg', '.webp', '.gif', '.bmp', '.png', '.jpeg']
    chooseWorkdir()
...
btn_ne.clicked.connect(workimage.to_negative)
